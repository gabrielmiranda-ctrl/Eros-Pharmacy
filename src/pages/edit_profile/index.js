  ...
  function updateProfile (birthDate, firstName, lastName, cpf, rg, notes) {
    if (
      ...
      const normalizeFirstName = firstName
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
      const maskFirstName = normalizeFirstName.replace(
        /[&\/\\#,@0123456789+()$~%.'":*?<>{}]/g,
        '',
      )
      ...
      const normalizeLastName = lastName
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
      const maskLastName = normalizeLastName.replace(
        /[&\/\\#,@0123456789+()$~%.'":*?<>{}]/g,
        '',
      )
    ...
    <Container>
      <Header>
        ...
        <Icons>
          <Update
            onPress={() =>
              updateProfile(birthDate, firstName, lastName, cpf, rg, notes)
            }>
