        ...
        <Content>
          <Header>
            <Flex>
              ...
              />
              <HeaderText>Ficha do paciente</HeaderText>
            </Flex>
          </Header>
          ...
          <Kinship1>
            ...
            <KinshipLine>
              <Icon2 name="bookmark" size={24} color={colors.green} style={{ paddingLeft: 15 }} />
              <KinshipValue>{kinshipType1}</KinshipValue>
            </KinshipLine>

            <KinshipLine>
              <Icon2 name="user" size={24} color={colors.green} style={{ paddingLeft: 15 }} />
              <KinshipValue>{kinshipName1}</KinshipValue>
            </KinshipLine>

            <KinshipLine>
              <Icon1 name="home-outline" size={24} color={colors.green} style={{ paddingLeft: 15 }} />
              <KinshipValue>{kinshipAddress1}</KinshipValue>
            </KinshipLine>

            <KinshipLine>
              <Icon2 name="phone" size={24} color={colors.green} style={{ paddingLeft: 15 }} />
